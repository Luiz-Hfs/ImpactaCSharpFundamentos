...
namespace Loja.WindowsForms
{
    internal static class Formulario
    {
        ...
        {         
            provedorErro.SetError(controle, mensagem);//SetError aparecer marcas de obrigatorio
            controle.Focus();
        ...
        private static bool ValidarTipoDado(Control controle, ErrorProvider provedorErro)
        {
            ...
            if (controleTag.Contains("PLACA"))
            {
                ...
                {
                    validacao = DefinirErro(provedorErro, controle,"Digite a placa no foranto AAA-0000");
                }
            }
